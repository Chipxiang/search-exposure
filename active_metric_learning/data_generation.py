...
if active_learning_option == "No":
    ...
    TRAINING_DATA_PATH = "/datadrive/ruohan/active_begin_train_test/ance_training_rank{}_nqueries{}_npassages{}_{}_{}.csv".format(
        RANK,
        N_QUERIES,
        TRAIN_SIZE,
        network_type,
        active_learning_stage)
    TEST_DATA_PATH = "/datadrive/ruohan/active_begin_train_test/ance_testing_rank{}_nqueries{}_npassages{}_{}_{}.csv".format(
        RANK,
        N_QUERIES,
        TEST_SIZE,
        network_type,
