...
EPOCH_SIZE = sys.argv[2]
BATCH_SIZE = sys.argv[3]
LEARNING_RATE = sys.argv[4]
print(NUM_EPOCHS, EPOCH_SIZE, BATCH_SIZE, LEARNING_RATE)
RANK = 10
TEST_BATCH = 35
...
def main(num_epochs, epoch_size, batch_size, learning_rate, model_path, rank, test_batch):
    ...
    output_path = model_path + timestamp_str + ".csv"
    with open(output_path, mode='a') as output:
        ...
        for ep_idx in range(num_epochs):
            ...
            avg_ndcg, avg_prec, avg_rr = test(net, test_batch, top_dict, query_test_dict, passage_dict, rating_dict, rank)
