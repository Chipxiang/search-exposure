...
def main(num_epochs, epoch_size, batch_size, learning_rate, model_path, rank, test_batch, embed_size, scale):
    ...
    arg_str = "random_negative_" + str(num_epochs) + "_" + str(epoch_size) + "_" + str(batch_size) + "_" + str(learning_rate) + "_" + str(
...
mini_batch(10, "cuda:2", train_rank_dict, query_dict, passage_dict)
